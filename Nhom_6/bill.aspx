...
<asp:SqlDataSource ID="bills" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:Assignment_Nhom6ConnectionString %>" DeleteCommand="DELETE FROM [HOA_DON] WHERE [Ma_HD] = @original_Ma_HD AND [Ma_KH] = @original_Ma_KH AND [Ma_NV] = @original_Ma_NV AND [NhayNhap] = @original_NhayNhap AND [TongTien] = @original_TongTien AND (([GhiChu] = @original_GhiChu) OR ([GhiChu] IS NULL AND @original_GhiChu IS NULL))" InsertCommand="INSERT INTO [HOA_DON] ([Ma_HD], [Ma_KH], [Ma_NV], [NhayNhap], [TongTien], [GhiChu]) VALUES (@Ma_HD, @Ma_KH, @Ma_NV, @NhayNhap, @TongTien, @GhiChu)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT [Ma_HD], [Ma_KH], [Ma_NV], [NhayNhap], [TongTien], [GhiChu] FROM [HOA_DON]" UpdateCommand="UPDATE [HOA_DON] SET [Ma_KH] = @Ma_KH, [Ma_NV] = @Ma_NV, [NhayNhap] = @NhayNhap, [TongTien] = @TongTien, [GhiChu] = @GhiChu WHERE [Ma_HD] = @original_Ma_HD AND [Ma_KH] = @original_Ma_KH AND [Ma_NV] = @original_Ma_NV AND [NhayNhap] = @original_NhayNhap AND [TongTien] = @original_TongTien AND (([GhiChu] = @original_GhiChu) OR ([GhiChu] IS NULL AND @original_GhiChu IS NULL))">
    <DeleteParameters>
